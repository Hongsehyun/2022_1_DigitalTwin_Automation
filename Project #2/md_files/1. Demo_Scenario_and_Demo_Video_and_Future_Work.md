...
2. Support Bar를 사용하지 않고, 물체 이동 중에 vaccum head가 물체를 Tracking해서 잡도록 하는 방안 (현재, 물체의 중심 좌표를 인식하고는 있음)



3. 물체의 모양에 따라 vaccum head가 잡을 수 있는 면을 인식하도록 하는 방안.



4. 여러 쓰레기들이 한 프레임에 함께 있을 때, 한 프레임 내 다중 Classification을 통한 연속적인 분리수거에 대한 방안
