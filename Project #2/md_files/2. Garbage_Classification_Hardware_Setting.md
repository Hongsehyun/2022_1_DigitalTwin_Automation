...
## Support Bar
컨베이어 벨트가 계속 동작하고 있는 상황에서 쓰레기를 고정된 자리에서 잡기 위해 쓰레기의 이동을 막는 지지대가 필요합니다. 데모 환경은 언제나 동일해야 하기 때문에 지지대의 아랫 부분을 돌출시켜 해당 위치에 고정할 수 있도록 했습니다. 해당 모델은 솔리드웍스 모델링 되고, 출력되었습니다. 모델의 파일은 **[Support_Bar_Modeling](https://github.com/Hongsehyun/2022_1_DigitalTwin_Automation/tree/main/Project%20%232/1.%20Hardware_Setting/Support_Bar_Modeling)** 에서 다운로드 가능합니다.

<p align="center">
	<img src="https://user-images.githubusercontent.com/107540262/174482330-75917ab5-32de-4851-94c0-654c99596045.png" width="50%" height="50%"/>
</p>
